  ...
  `;
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo;
            offset = deleteNotDig(width) * (slideTo - 1);
...
window.addEventListener('DOMContentLoaded', function () {
    const modalTimerId = setTimeout( () => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalTimerId), 400000);
